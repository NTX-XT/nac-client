...
import { IExecutionContextConfiguration, INWCClientAppCredentials, INWCConnectionInfo, INWCConnectorInfo, INWCDataSource, INWCDatasourceContract, INWCImportedWorkflowResponse, INWCTag, INWCTenantDetails, INWCTenantInfo, INWCUser, INWCWorkflowInfo, INWCWorkflowPublishPayload, INWCWorkflowSource } from './model'
...
export class NWCTenant {
	...
	private static async connect(
		...
		const tenant = new NWCTenant(executionContextConfiguration || new DefaultExecutionContextConfiguration())
	...
	public async getTags(): Promise<INWCTag[]> {
		...
		for (const item of result.resource)
