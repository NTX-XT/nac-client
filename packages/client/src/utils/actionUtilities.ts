...
export enum KnownParameterNames {
    ComponentWorkflowId = "wfId",
    XtensionInput = "['X_NTX_XTENSION_INPUT']",
    ConnectionId = "NTX_CONNECTION_ID"
}
...
export class ActionUtilities {
    ...
    public static getXtensionInputParameter = (action: action): parameter | undefined => ActionUtilities.getParameter(ActionUtilities.getPropertyFromParameterName(action, KnownParameterNames.XtensionInput), KnownParameterNames.XtensionInput);
    ...
    public static getComponentWorkflowIdValue = (action: action): string | undefined => ActionUtilities.getNamedParameterValue(action, KnownParameterNames.ComponentWorkflowId);
    public static getXtensionInputValue = (action: action): any | undefined => ActionUtilities.getNamedParameterValue(action, KnownParameterNames.XtensionInput);
    public static getConnectionId = (parameter?: parameter): string | undefined => ActionUtilities.getParameterValue(parameter)
        ? ActionUtilities.getParameterValue(parameter)[ActionUtilities.getParameterValueKey(parameter, KnownParameterNames.ConnectionId)]?.data.id
        : undefined;
